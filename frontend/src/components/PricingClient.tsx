      ...
      <ScrollReveal>
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          ...
          <p className="text-sm sm:text-base text-zinc-400 leading-relaxed">
            ...
            <Link href="/create" className="text-zinc-200 underline hover:text-white transition-colors">
              link generator
            </Link>
            , or upgrade to unlock custom slugs, branded subdomains, and high-rate-limit API access. Review our{" "}
