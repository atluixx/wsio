        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
          <div className="flex items-start gap-3.5 flex-1">
            ...
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <span className="inline-flex items-center rounded-md bg-white/5 px-2 py-0.5 text-[10px] font-medium text-zinc-300 border border-white/10">
                  LGPD &amp; GDPR Compliant
                </span>
              </div>
              <p className="text-xs text-zinc-400 leading-relaxed max-w-2xl">
                ...
                <Link href="/privacy" className="text-white underline underline-offset-4 hover:text-zinc-200 font-medium">
                  Privacy Policy
                </Link>{" "}
                for full details.
              </p>
          ...
          <div className="flex items-center gap-2.5 shrink-0 w-full md:w-auto justify-end">
            <Button
              ...
              className="text-xs border-white/10 bg-zinc-900/60 text-zinc-300 hover:bg-zinc-800 hover:text-white"
            >
            ...
            <Button
              ...
              className="text-xs font-semibold bg-white text-zinc-950 hover:bg-zinc-200 px-4"
            >
              Accept
            </Button>
          </div>
